...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/cool-dream-4d2e)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/cool-dream-4d2e
```

A live public deployment of this template is available at [https://cool-dream-4d2e.templates.workers.dev](https://cool-dream-4d2e.templates.workers.dev)
